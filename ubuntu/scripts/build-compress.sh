...
echo
sleep 2
tar -xf /tmp/"lz4_${_lz4_ver}-1_amd64.tar.xz" -C /
/sbin/ldconfig
rm -fr /tmp/lz4
...
echo
sleep 2
tar -xf /tmp/"zstd_${_zstd_ver}-1_amd64.tar.xz" -C /
/sbin/ldconfig
rm -fr /tmp/zstd
...
echo
sleep 2
tar -xf /tmp/"tar_${_tar_ver}-1_amd64.tar.xz" -C /
/sbin/ldconfig
rm -fr /tmp/tar
